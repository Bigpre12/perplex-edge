...
function PlayerRow({ expanded, onClick, image, name, pos, matchup, time, prop, line, odds, sportsbook, edge, confidence, progress, trendData, matchupData, usageData, performanceSplits, volatility, idx, injuryStatus }: any) {
                        ...
                        >
                            ...
                            <div className="w-64 flex flex-col gap-4">
                                <SportsbookDeeplinks
                                    ...
                                    odds={parseInt(odds)}
                                />
                                <button className="w-full py-3 border border-white/10 glass-premium text-slate-300 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-white/5 transition-all">ADD TO TRACKER</button>
                            </div>
                        </motion.div>
                    </td>
                </tr>
