...
import { Database, MemoryStick as Memory, Globe, Activity, Brain, Loader2 } from 'lucide-react';
        ...
        <div className="space-y-8">
                    ...
                    <div className="glass-panel rounded-xl flex-1 flex flex-col overflow-hidden max-h-[400px]">
                        ...
                        <div className="overflow-y-auto flex flex-col">
                            {healing?.ai_evaluation ? (
                                ...
                                <LogItem type="Monitoring" time={new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })} message="Awaiting healing cycle data..." color="text-primary" />
                            )}
                        </div>
                    </div>
                </div>
            ...
            <div className="glass-panel p-6 rounded-xl">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link to="/player-props" className="text-xs text-primary hover:text-white transition-colors flex items-center gap-1">
