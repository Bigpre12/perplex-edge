...
import { Share2, ArrowLeft, Brain, Info } from 'lucide-react';
...
export default function TailLink() {
    ...
    if (error || !data) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center gap-4">
                ...
                <Link to="/player-props" className="mt-4 px-6 py-2 bg-primary text-background-dark font-bold rounded-lg uppercase text-xs tracking-widest">
                    Back to Feed
                </Link>
            </div>
        );
    ...
    return (
        <div className="max-w-2xl mx-auto py-12 px-4 space-y-8">
            <Link to="/player-props" className="inline-flex items-center gap-2 text-slate-500 hover:text-white transition-colors text-sm font-bold group">
            ...
            <div className="glass-panel p-8 rounded-3xl border-primary/20 bg-primary/5 space-y-8 relative overflow-hidden">
                ...
                <p className="text-center text-[10px] text-slate-600 font-bold uppercase tracking-widest">
                    Generated by Perplex Edge Intelligence • Powered by LOLA v2
                </p>
            </div>
        </div>
    );
