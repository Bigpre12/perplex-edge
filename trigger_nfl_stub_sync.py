#!/usr/bin/env python3
"""
Trigger NFL sync with stub data
"""
import requests

def trigger_nfl_stub_sync():
    """Trigger NFL sync with stub data"""
    base_url = "https://railway-engine-production.up.railway.app"
    
    print("TRIGGERING NFL SYNC WITH STUB DATA")
    print("="*80)
    
    # Trigger NFL games sync with stubs
    print("\n1. NFL Games Sync with Stubs:")
    nfl_sync_url = f"{base_url}/api/nfl/games/sync?include_props=true&generate_picks=true&use_stubs=true"
