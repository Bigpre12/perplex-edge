...
class RefereeService:
    def get_ref_tendencies(self, crew: list, db: Session) -> dict:
        if not crew:
    ...
    def get_game_refs(self, game_id: str, db: Session) -> list:
...
get_ref_tendencies = referee_service.get_ref_tendencies
get_game_refs = referee_service.get_game_refs
