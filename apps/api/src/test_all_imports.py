...
modules = [
    ...
    ("models.user", "import models.user"),
    ("models.prop", "import models.prop"),
    ("models.brain", "import models.brain"),
    ("models.bet", "import models.bet"),
