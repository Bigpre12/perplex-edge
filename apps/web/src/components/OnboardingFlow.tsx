  ...
  return (
    <div style={{ maxWidth: 480, margin: '80px auto', padding: 32, background: '#111', borderRadius: 16, color: '#fff' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 700 }}>Welcome to LOLA âœ¦</h1>
        <p style={{ color: '#888' }}>Quick setup â€” takes 30 seconds</p>
      </div>
      ...
      {step === 1 && (
        <div>
          ...
          <button onClick={() => setStep(2)} style={{ marginTop: 24, width: '100%', padding: '12px', background: '#3b82f6', color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer', fontWeight: 700 }}>Next â†’</button>
        </div>
      )}
      ...
      {step === 2 && (
        <div>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 24 }}>
            ...
            <button onClick={() => setStep(3)} style={{ flex: 2, padding: 12, background: '#3b82f6', color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer', fontWeight: 700 }}>Next â†’</button>
          </div>
        </div>
      )}
      ...
      {step === 3 && (
        <div>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 24 }}>
            ...
            <button onClick={finish} style={{ flex: 2, padding: 12, background: '#16a34a', color: '#fff', border: 'none', borderRadius: 8, cursor: 'pointer', fontWeight: 700 }}>ðŸš€ Launch LOLA</button>
          </div>
        </div>
      )}
    </div>
