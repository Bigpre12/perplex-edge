...
export default function AffiliateDashboard() {
    ...
    const handleCopy = () => {
        ...
        const link = `https://lucrix.ai?ref=${referralData.referral_code}`;
    ...
    return (
        <GateLock feature="export" reason="The Partner Program is active for Sharp & Elite members.">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-8">
                            <div className="flex-1 bg-black/40 border border-slate-700/50 rounded-xl px-4 py-3 flex items-center justify-between font-mono text-sm text-slate-300">
                                <span className="truncate mr-4 flex-1">
                                    https://lucrix.ai?ref=<span className="text-primary font-bold">{referralData?.referral_code}</span>
                                </span>
