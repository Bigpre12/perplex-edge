...
function ExecutionContent() {
    ...
    const generateKey = async () => {
        ...
        try {
            ...
            if (!isApiError(data)) {
                ...
                setError(`Key generation failed (${data.status}). ${data.message}`);
            }
        } catch (err) {
    ...
    return (
        <GateLock feature="export" reason="Algorithmic execution and Webhook relays are institutional-grade professional tools.">
