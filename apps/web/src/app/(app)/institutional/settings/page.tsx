...
function EdgeSettingsContent() {
    ...
    const saveSettings = async () => {
        ...
        try {
            ...
            if (!isApiError(data)) {
                ...
                throw new Error(data.message || "Server rejected settings payload");
            }
        } catch (err: any) {
            setStatusBlock({ msg: err.message || "Failed to save configuration settings.", isError: true });
        } finally {
            setSaving(false);
    ...
    return (
        <GateLock feature="export" reason="Edge Engine thresholds and API webhooks are restricted to Elite partners.">
