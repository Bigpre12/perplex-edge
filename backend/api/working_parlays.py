...
async def get_working_parlays(
    ...
    try:
        ...
        if not games:
            ...
            return {
                "game_name": "No live games currently",
                "parlays": [
                    {
                        "id": 1,
                        "game_id": "mock",
                        "game_name": "Sample Parlay (Off-Hours)",
                        "total_ev": 0.042,
                        "total_odds": 6.25,
                        "parlay_hit_rate": 0.16,
                        "legs": [
                            {"player_name": "LeBron James", "stat_type": "points", "line_value": 25.5, "side": "over", "odds": -110, "edge": 0.032, "simulated_hit_rate": 0.55},
                            {"player_name": "Stephen Curry", "stat_type": "points", "line_value": 28.5, "side": "over", "odds": -115, "edge": 0.028, "simulated_hit_rate": 0.53}
                        ],
                        "confidence_score": 0.16,
                        "simulations": 5000,
                        "ai_reasoning": "Historical backtest parlay — no live games at this time.",
