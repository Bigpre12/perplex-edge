...
class Settings(BaseSettings):
    ...
    whop_pro_monthly_checkout_url: str = "https://whop.com/checkout/plan_8Qztt62kvlW8y"
    whop_pro_yearly_checkout_url: str = "https://whop.com/checkout/plan_eeIAyl9zqIhfb"
