...
from app.api.test_raw_service import router as test_raw_service_router
...
app.include_router(brain_persistence_router, prefix="/api", tags=["brain-persistence"])
app.include_router(debug_router, prefix="/api", tags=["debug"])
app.include_router(debug_parlay_router, prefix="/api", tags=["debug-parlay"])
app.include_router(debug_simple_router, prefix="/api", tags=["debug-simple"])
app.include_router(debug_raw_parlay_router, prefix="/api", tags=["debug-raw-parlay"])
app.include_router(test_raw_service_router, prefix="/api", tags=["test-raw-service"])
app.include_router(debug_raw_service_router, prefix="/api", tags=["debug-raw-service"])
app.include_router(debug_sport_data_router, prefix="/api", tags=["debug-sport-data"])
app.include_router(multisport_parlay_router, prefix="/api", tags=["multisport"])
app.include_router(fix_nhl_data_router, prefix="/api", tags=["fix-nhl-data"])
app.include_router(parlay_status_router, prefix="/api", tags=["parlay-status"])
app.include_router(sportsbook_intelligence_router, prefix="/api", tags=["sportsbook"])
...
app.include_router(debug_markets_router, prefix="/api", tags=["debug-markets"])
app.include_router(debug_multisport_router, prefix="/api", tags=["debug-multisport"])
app.include_router(debug_slates_router, prefix="/api", tags=["debug-slates"])
app.include_router(debug_candidates_router, prefix="/api", tags=["debug-candidates"])
app.include_router(candidates_router, prefix="/api", tags=["candidates"])
app.include_router(debug_ev_router, prefix="/api", tags=["debug-ev"])
app.include_router(clv_dashboard_router, prefix="/api", tags=["clv"])
app.include_router(calibration_router, prefix="/api", tags=["calibration"])
app.include_router(line_movement_router, prefix="/api", tags=["line-movement"])
app.include_router(correlation_router, prefix="/api", tags=["correlation"])
app.include_router(line_shopping_router, prefix="/api", tags=["line-shopping"])
app.include_router(performance_attribution_router, prefix="/api", tags=["attribution"])
app.include_router(advanced_analytics_router, prefix="/api", tags=["advanced-analytics"])
app.include_router(model_validation_router, prefix="/api", tags=["validation"])
app.include_router(grading_router, prefix="/api", tags=["grading"])
app.include_router(brain_control_router, prefix="/api", tags=["brain-control"])
app.include_router(roster_control_router, prefix="/api", tags=["roster-control"])
app.include_router(frontend_endpoints_router, prefix="/api", tags=["frontend-mapping"])
app.include_router(data_integrity_router, prefix="/api", tags=["data-integrity"])
app.include_router(brain_status_router, prefix="/api", tags=["brain-status"])
app.include_router(data_integrity_status_router, prefix="/api", tags=["data-integrity-status"])
app.include_router(roster_status_router, prefix="/api", tags=["roster-status"])
