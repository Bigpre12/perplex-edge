...
async def get_game_free_parlays(sport_id: int = Query(None, description = "Filter by sport ID"),
...
async def get_available_picks_game_free(sport_id: int = Query(None, description = "Filter by sport ID"),
