...
async def get_props_for_sport(db: AsyncSession,
 sport_id: int,
 target_date: datetime,
 min_ev: float = 0.0,
 min_confidence: float = 0.0,
 limit: int = 50,) - > list[PlayerPropPick]:
 """
...
async def get_full_slate(date: str = Query(..., description = "ISO date, e.g. 2026 - 02 - 04"),
 ...
 props = await get_props_for_sport(db = db,
 sport_id = sport_id,
 ...
 sports_slates.append(SportSlate(sport_id = sport_id,
 sport_key = sport_key,
 ...
 return FullSlateResponse(date = date,
