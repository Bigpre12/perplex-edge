...
async def get_supported_sports_endpoint(db: AsyncSession = Depends(get_db)):
...
async def build_multisport_parlay(sport_id: int,
 ...
 return ParlayBuilderResponse(parlays = parlays,
