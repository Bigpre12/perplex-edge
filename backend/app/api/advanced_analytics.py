...
async def analyze_pick_comprehensive(pick_id: int,
...
async def analyze_game_comprehensive(game_id: int,
 db: AsyncSession = Depends(get_db)):
...
async def get_analytics_summary(sport_id: int = Path(description = "Sport ID"),
...
async def optimize_parlay_with_analytics(game_id: int,
