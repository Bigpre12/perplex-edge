...
async def get_line_movements(limit: int = Query(default = 20, le = 100),
...
async def get_over_under_opportunities(min_edge: float = Query(default = 5.0, description = "Minimum edge percentage"),
