...
async def ultimate_override_parlays(sport_id: int = Query(None, description = "Filter by sport ID"),
...
async def force_show_parlays(sport_id: int = Query(None, description = "Filter by sport ID"),
 limit: int = Query(default = 10, le = 50),
 db: AsyncSession = Depends(get_db)):
