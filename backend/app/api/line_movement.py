...
async def track_line_movements(sport_id: int = Path(default = ..., description = "Sport ID"),
...
async def get_line_movement_alerts(sport_id: int = Path(description = "Sport ID"),
 db: AsyncSession = Depends(get_db)):
