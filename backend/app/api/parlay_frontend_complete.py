...
async def frontend_complete_parlays(sport_id: int = Query(None, description = "Filter by sport ID"),
...
async def mock_active_slates(sport_id: int = Query(None, description = "Sport ID"),
 platform: str = Query(default = "prizepicks", description = "Platform")):
...
async def mock_live_odds(platform: str = Query(default = "prizepicks", description = "Platform")):
