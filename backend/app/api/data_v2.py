...
async def get_odds(sport_key: str,
 ...
 response = await service.get_live_odds(sport_key,
...
async def get_player_props(sport_key: str,
 ...
 """
 service = get_odds_service()
 response = await service.get_player_props(sport_key,
 game_id = game_id,
 force_refresh = force_refresh,)
...
async def get_schedule(sport_key: str,
 ...
 response = await service.get_games(sport_key,
...
async def get_today_schedule(sport_key: str,
 force_refresh: bool = Query(False, description = "Skip cache"),):
...
async def get_injured_player_ids(sport_key: str,):
 """
...
async def clear_cache(live_only: bool = Query(False, description = "Only clear live cache"),):
 """
 Clear cache.
