#!/usr/bin/env python3
"""
Trigger NFL games sync with player props
"""
import requests

def trigger_nfl_games_sync():
    """Trigger NFL games sync with player props"""
    base_url = "https://railway-engine-production.up.railway.app"
    
    print("TRIGGERING NFL GAMES SYNC WITH PLAYER PROPS")
    print("="*80)
    
    # Trigger NFL games sync with props
    print("\n1. NFL Games Sync with Player Props:")
    nfl_sync_url = f"{base_url}/api/nfl/games/sync?include_props=true&generate_picks=true&use_stubs=false"
