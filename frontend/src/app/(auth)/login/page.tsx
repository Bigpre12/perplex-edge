...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Use URLSearchParams for OAuth2PasswordRequestForm expected by FastAPI
            const formBody = new URLSearchParams();
            formBody.append("username", formData.email); // Our backend expects username field in form data, we pass email
