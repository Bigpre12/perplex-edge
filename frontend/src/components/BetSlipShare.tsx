...
export default function BetSlipShare({ pick }: any) {
    ...
    const captureSlip = async () => {
        ...
        try {
            ...
            link.href = image;
            link.download = `PerplexEdge_Verified_${pick.player_name || 'Shot'}.png`;
            link.click();
                ...
                >
                    ...
                    <div className="relative z-10 flex items-center justify-between border-b-4 border-white/10 pb-20">
                        <div>
                            ...
                            <h1 className="text-white text-[120px] font-black tracking-[-0.05em] leading-[0.8] mb-2">PERPLEX</h1>
                    ...
                    <div className="relative z-10 flex items-center justify-between border-t-4 border-white/10 pt-20">
                        <div className="space-y-4">
                            ...
                            <p className="text-white text-5xl font-black tracking-tight">perplexedge.com</p>
                        </div>
